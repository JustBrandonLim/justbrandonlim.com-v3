    ...
    <>
      ...
      <section id="contact" className="container max-w-3xl p-5 text-center">
        ...
        <div className="flex flex-col items-center gap-5 text-lg">
          ...
          <a className="px-5 py-3 text-white rounded-sm w-max bg-sky-500 hover:bg-sky-400" href="mailto:hello@justbrandonlim.com" aria-label="Email" target="_blank" rel="noopener noreferrer">
            Say Hello
          </a>
        </div>
      </section>
